 ...
 * [clkgho.yml](clkgho.yml)
     * Determines how your purl.obolibrary.org/obo/clkgho/ redirects will be handled
     ...
     * Paste in the contents of [clkgho.yml](clkgho.yml)
 ...
 * [clkgho.md](clkgho.md)
     ...
     * Paste in the contents of [clkgho.md](clkgho.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
